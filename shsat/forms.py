...
DISTRACTOR_CHOICES = [
    ...
    ("ELA", [
        ...
        ("wrong_logical_relation", "(E) Wrong Logical Relation"),
        ("changes_meaning", "(E) Changes Meaning"),
        ("wrong_placement", "(E) Wrong Placement"),
    ...
    ("Math", [
        ...
        ("unit_error", "(M) Unit Error"),
        ("unit_conversion_error", "(M) Unit Conversion Error"),
    ...
    ("General", [
        ("introduces_new_error", "Introduces New Error"),
